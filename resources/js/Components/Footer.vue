      ...
      <div class="grid grid-cols-2 gap-x-6 gap-y-8 lg:grid-cols-4 lg:gap-10">
        ...
        <div class="col-span-1 lg:col-span-1">
          ...
          <ul class="space-y-2.5">
            ...
            <li><Link :href="route('shop.index', { category: 'sweets' })" class="footer-link">Sweets</Link></li>
            <li><Link :href="route('shop.index', { category: 'ramadan-menu' })" class="footer-link">Ramadan Menu</Link></li>
          </ul>
        </div>
