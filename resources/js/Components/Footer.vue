<template>
  <footer class="bg-charcoal text-white mt-20">
    <div class="gradient-green h-1"></div>
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
        ...
        <div class="lg:col-span-1">
          ...
          <p class="text-gray-400 text-sm leading-relaxed mb-6">
            Lavender Grocery & Mart brings you the freshest produce, dairy, meat, snacks, and household essentials delivered right to your door — fast, fresh, and trusted.
          </p>
        ...
        <div>
          ...
          <ul class="space-y-3">
            ...
            <li><Link :href="route('shop.index')" class="footer-link">Shop Now</Link></li>
            <li><Link :href="route('offers')"     class="footer-link">Offers & Deals</Link></li>
        ...
        <div>
          ...
          <ul class="space-y-3">
            <li><Link :href="route('shop.index', { category: 'fresh-vegetables' })" class="footer-link">Fresh Vegetables</Link></li>
            <li><Link :href="route('shop.index', { category: 'fresh-fruits' })"     class="footer-link">Fresh Fruits</Link></li>
            <li><Link :href="route('shop.index', { category: 'dairy-eggs' })"       class="footer-link">Dairy & Eggs</Link></li>
            <li><Link :href="route('shop.index', { category: 'meat-fish' })"        class="footer-link">Meat & Fish</Link></li>
            <li><Link :href="route('shop.index', { category: 'snacks-beverages' })" class="footer-link">Snacks & Beverages</Link></li>
            <li><Link :href="route('shop.index', { category: 'frozen-foods' })"     class="footer-link">Frozen Foods</Link></li>
          </ul>
        </div>
    ...
    <div class="border-t border-gray-700/50">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 flex flex-col md:flex-row items-center justify-between gap-4">
        <p class="text-gray-500 text-sm text-center">
          © {{ new Date().getFullYear() }} Lavender Grocery & Mart. All rights reserved.
        </p>
